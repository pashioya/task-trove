          ...
          <ScrollView>
            <View>
              <View>
                ...
                <View className="bg-secondary flex-row items-center justify-start h-12 bg-gray-100 rounded-lg mb-3 px-3">
                  <View
                  ...
                  <Switch
                    ...
                    style={{
                      backgroundColor: isDarkColorScheme ? colors.blue[500] : colors.gray[300],
                    }}
